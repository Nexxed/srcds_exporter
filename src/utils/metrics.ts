...
export const metrics = {
	status: new Gauge({
		...
		registers: [
			...
			registries.cssRegistry,
			registries.hl2Registry,
			registries.tf2Registry,
	...
	maps: new Gauge({
		...
		registers: [registries.csgoRegistry, registries.gmodRegistry, registries.cssRegistry, registries.hl2Registry, registries.tf2Registry]
	}),
	fps: new Gauge({
		name: "srcds_fps",
	...
	connects: new Gauge({
		name: "srcds_connects",
		help: "Number of players who connected on the server since it's boot",
		registers: [registries.gmodRegistry, registries.cssRegistry, registries.hl2Registry, registries.tf2Registry]
	}),
	users: new Gauge({
		name: "srcds_users",
		help: "Number of users who connected on the server since it's boot",
		registers: [registries.l4d2Registry]
	}),

	player_ping: new Gauge({
		name: "srcds_player_ping",
		help: "The latency of all connected players",
		registers: [registries.csgoRegistry],
		labelNames: ["id", "name", "uniqueid"]
	}),

	player_loss: new Gauge({
		name: "srcds_player_loss",
		help: "The packet loss of all connected players",
		registers: [registries.csgoRegistry],
		labelNames: ["id", "name", "uniqueid"]
	}),

	player_rate: new Gauge({
		name: "srcds_player_rate",
